...
#import "RCGPUImageC004Filter.h"

@implementation RCGPUImageC004Filter
- (id)init
{
    if (!(self = [super init]))
    {
    ...
    if (rand==0)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"4-01" ofType:@"png"]];
    }
    else if (rand==1)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"4-02" ofType:@"png"]];
    }
    else if (rand==2)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"4-03" ofType:@"png"]];
    }
