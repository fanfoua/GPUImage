...
#import "RCGPUImageInsSlumberFilter.h"
#import "Modules/RCGPUImageMapFilter.h"
#import "Modules/RCGPUImageYMapFilter.h"

@implementation RCGPUImageInsSlumberFilter
- (id)init
{
    if (!(self = [super init]))
    {
...
//    UIImage *image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle pathForResource:@"ins_slumber_map" ofType:@"png"]];
    UIImage *image1 = [UIImage imageWithData:[RCDecrypt dealDecrypt:[resBundle URLForResource:@"ins_slumber_map" withExtension:@"png"]]];
    NSAssert(image1, @"To use RCGPUImageInsSlumberFilter you need to add ins_slumber_map.png to your application bundle.");
