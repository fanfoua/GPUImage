...
#import "RCGPUImageC005Filter.h"

@implementation RCGPUImageC005Filter
- (id)init
{
    if (!(self = [super init]))
    {
    ...
    GPUImageToneCurveFilter *ToneCurveFilter1 = [[GPUImageToneCurveFilter alloc] initWithACVURL:[resBundle URLForResource:@"R501_1" withExtension:@"acv"] mixturePercent:0.5];
    ...
    if (rand==0)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"5-01" ofType:@"png"]];
    }
    else if (rand==1)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"5-02" ofType:@"png"]];
    }
    else if (rand==2)
    {
        image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle
                                                          pathForResource:@"5-03" ofType:@"png"]];
    }
