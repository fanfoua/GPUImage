...
#import "RCGPUImageInsJunoFilter.h"
#import "Modules/RCGPUImageMapFilter.h"

@implementation RCGPUImageInsJunoFilter
...
//    UIImage *image1 = [[UIImage alloc] initWithContentsOfFile:[resBundle pathForResource:@"ins_juno_map" ofType:@"png"]];
    UIImage *image1 = [UIImage imageWithData:[RCDecrypt dealDecrypt:[resBundle URLForResource:@"ins_juno_map" withExtension:@"png"]]];
    NSAssert(image1, @"To use RCGPUImageInsJunoFilter you need to add ins_juno_map.png to your application bundle.");
