...
NSString *const kRCGPUImageSixthInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation RCGPUImageSixInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRCGPUImageSixthInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
