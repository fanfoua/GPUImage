...
NSString *const kRCGPUImageFiveInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation RCGPUImageFiveInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRCGPUImageFiveInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
