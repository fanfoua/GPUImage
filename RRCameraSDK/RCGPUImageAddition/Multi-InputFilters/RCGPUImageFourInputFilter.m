...
NSString *const kRCGPUImageFourInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation RCGPUImageFourInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRCGPUImageFourInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
